...
SIMAPP = ./app
HTTPS_GIT := https://github.com/hap-advisors/ethermint.git
...
docker-build:
	...
	docker create --name ethermint -t -i ethermint:latest ethermint
...
PACKAGE_NAME:=github.com/hap-advisors/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/hap-advisors/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/hap-advisors/ethermint/tests/importer
